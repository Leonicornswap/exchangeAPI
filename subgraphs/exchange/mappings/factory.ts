...
import { LeonicornFactory, Pair, Token, Bundle } from "../generated/schema";
...
export function handlePairCreated(event: PairCreated): void {
  let factory = LeonicornFactory.load(FACTORY_ADDRESS);
  if (factory === null) {
    factory = new LeonicornFactory(FACTORY_ADDRESS);
